...
function giftOrderEmailTemplate({ 
  ...
  return `
    <h2>Tassel Group – Gift Package Order Confirmation</h2>
...
router.post('/', cacheMiddleware(300), auth, async (req, res) => {
  try {
    ...
    await transporter.sendMail({
      ...
      subject: `New Gift Package Order – ${recipientName}`,
      html
    });

    console.log('✅ Gift order created and emails sent:', giftOrder._id);
